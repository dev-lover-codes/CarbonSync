# **AI Development Guidelines for React + Vite in Firebase Studio**

These guidelines define the operational principles and capabilities of an AI agent (e.g., Gemini) interacting with React + Vite projects within the Firebase Studio environment.

## **Environment & Context Awareness**

* **Project Structure (Vite):**
  * `/src`: The core directory.
...
* **Vite Config:** Standard `vite.config.ts`.
* **Firebase Integration:** Uses `firebase` SDK. Configured in `src/lib/firebase.js`.

## **Code Modification & Dependency Management**

* **Package Management:** `npm`.
* **Vite CLI:** `npm run dev`, `npm run build`, `npm run lint`.

## **Automated Error Detection & Remediation**

* **Post-Modification Checks:** Run `npm run lint -- --fix` and check Vitest for unit tests.
